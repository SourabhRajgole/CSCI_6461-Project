...
public class MachineSimulator {
    ...
    private void createUI() {
        ...
        gbc.gridx = 1;
        gbc.gridy = 3;
        gbc.gridwidth = 2;  // Let the text field span two columns
        ...
        JButton[] buttons = { loadButton, storeButton, storePlusButton, loadPlusButton,
        ...
        gbc.gridx = 0;
        gbc.gridy = 4;
        gbc.gridwidth = 4;  // Let it span multiple columns
        ...
        JScrollPane consoleOutputScroll = new JScrollPane(consoleOutput);
        consoleOutputScroll.setBorder(BorderFactory.createTitledBorder("Console Output"));
        consolePanel.add(consoleOutputScroll, BorderLayout.SOUTH);
    ...
    private void executeInstruction(int instruction) {
        ...
        switch (opcode) {
            ...
            case "100010":  // STX
                ...
                break;
            case "000000":
                printerArea.append("NOP (or HLT=0) at PC " + PC + ".\n");
                break;
            default:
